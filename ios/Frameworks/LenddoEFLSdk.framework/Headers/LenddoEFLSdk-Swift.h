...
- (void)setThemeColor:(UIColor * _Nonnull)themeColor;
...
- (void)setDocumentParts:(NSArray<DocumentParts *> * _Nonnull)parts;
- (NSArray<DocumentParts *> * _Nonnull)getDocumentParts SWIFT_WARN_UNUSED_RESULT;
...
- (void)onDocumentSaveSuccessWithIndex:(NSInteger)index;
- (void)onDocumentStepComplete;
@end


SWIFT_CLASS("_TtC12LenddoEFLSdk13DocumentParts")
@interface DocumentParts : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setTranslation:(NSString * _Nonnull)translation;
- (void)setTranslationKey:(NSString * _Nonnull)translationKey;
...
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> * _Nonnull)info;
- (void)imagePickerControllerDidCancel:(UIImagePickerController * _Nonnull)picker;
- (void)livenessSubmitError:(NSError * _Nonnull)error;
- (void)livenessSubmitSuccess:(float)progress;
